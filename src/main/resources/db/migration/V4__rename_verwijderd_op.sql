...
CREATE INDEX idx_voorkeur_retention ON voorkeur (last_used_at) WHERE verwijderd_op IS NULL;
CREATE INDEX idx_contactgegeven_retention ON contactgegeven (last_used_at) WHERE verwijderd_op IS NULL;
