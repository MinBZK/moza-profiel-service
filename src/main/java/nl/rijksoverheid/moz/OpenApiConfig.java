 ...
 */
@OpenAPIDefinition(info = @Info(title = "MOZa Profiel Service API", version = ApiVersion.CURRENT, description = "Profiel service voor MijnOverheid Zakelijk: beheer van contactgegevens en communicatievoorkeuren van partijen.", contact = @Contact(name = "MijnOverheid Zakelijk Team", email = "moza@minbzk.nl", url = "https://docs.mijnoverheidzakelijk.nl"), license = @License(name = "EUPL-1.2", url = "https://joinup.ec.europa.eu/software/page/eupl")), servers = {
