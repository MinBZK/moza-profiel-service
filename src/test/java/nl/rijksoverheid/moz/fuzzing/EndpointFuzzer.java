 ...
 * Fuzzes all REST endpoints via HTTP against a running Quarkus instance.
 * The wrapper script starts Quarkus with an in-memory H2 database before
 * launching jazzer_driver.
 */
