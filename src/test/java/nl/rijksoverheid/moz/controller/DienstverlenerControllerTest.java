...
public class DienstverlenerControllerTest {
    ...
    @Test
    void getAfdelingenDienstverlener_Success() {
        ...
        QuarkusTransaction.requiringNew().run(() -> {
            ...
            a.setBeschrijving("Test");
            a.setDienstverlener(d);
            a.persist();
        ...
        given()
                ...
                .body("afdelingen[0].id", org.hamcrest.Matchers.equalTo((int) id.get()))
                .body("afdelingen[0].beschrijving", org.hamcrest.Matchers.equalTo("Test"));

    }

    @Test
    void getAfdelingenDienstverlener_NotFound() {
        given()
                .contentType(ContentType.JSON)
                .get("/api/profielservice/v1/dienstverlener/Test")
                .then()
    ...
    @Test
    void addAfdelingToDienstverlener_Success() {
        ...
        given()
                .contentType(ContentType.JSON)
                .body(request)
                .post("/api/profielservice/v1/dienstverlener/Test/afdelingen")
                .then()
                .statusCode(CREATED)
                .header("Location", org.hamcrest.Matchers.endsWith("/dienstverlener/Test"));
    ...
    @Test
    void addAfdelingToDienstverlener_BadRequest() {
        given()
                .contentType(ContentType.JSON)
                .post("/api/profielservice/v1/dienstverlener/Test/afdelingen")
                .then()
